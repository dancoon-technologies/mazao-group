# Initial migration: SiteConfig only (visit/GPS fields). Partner/location labels in 0003, DepartmentTerminology in 0004.
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.PositiveSmallIntegerField(default=5, help_text="Max visit photo size in MB."),
                ),
            ],
            options={
