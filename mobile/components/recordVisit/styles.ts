...
export const styles = StyleSheet.create({
  ...
  fieldLabel: { marginTop: 0, marginBottom: spacing.xs, fontWeight: '700', color: colors.gray900 },
  hint: { marginTop: 0, marginBottom: spacing.sm, opacity: 0.85 },
  ...
  farmerCardMeta: { color: colors.gray500, marginTop: 2 },
  ...
  selectedLocationRow: { flexDirection: 'row', alignItems: 'center' },
  selectedLocationTextWrap: { marginLeft: spacing.sm, flex: 1 },
  selectedLocationTitle: { color: colors.gray500, marginBottom: 2 },
  selectedLocationValue: { fontWeight: '700', color: colors.gray900 },
  farmSelectBtn: { marginBottom: spacing.xs },
  farmSelectBtnContent: { justifyContent: 'flex-start' },
  muted: { opacity: 0.7 },
  farmerSelectBtn: { marginBottom: spacing.md },
  farmerSelectBtnContent: { justifyContent: 'flex-start' },
  partnerTypeRow: { flexDirection: 'row', gap: 8, marginBottom: spacing.md },
  partnerTypeBtn: { flex: 1, borderRadius: radius.md },
  partnerTypeBtnActive: { backgroundColor: colors.primaryLight },
  partnerTypeBtnInactive: { opacity: 0.82 },
  partnerTypeBtnLabel: { fontWeight: '600', letterSpacing: 0.2 },
  ...
  photosRow: { flexDirection: 'row', flexWrap: 'wrap', gap: spacing.sm, marginBottom: spacing.lg, alignItems: 'flex-start' },
  ...
  errorHint: { marginTop: 2, marginBottom: 0 },
  scheduleChips: { flexDirection: 'row', flexWrap: 'wrap', gap: spacing.sm, marginTop: spacing.xs },
  ...
  errorBlock: { marginTop: 2, marginBottom: spacing.sm },
  actionsSection: { paddingTop: spacing.sm, paddingBottom: spacing.xs },
  nextBtn: { marginBottom: spacing.xs },
  ...
  stepActions: { flexDirection: 'row', gap: spacing.md, marginTop: spacing.sm, marginBottom: spacing.md },
