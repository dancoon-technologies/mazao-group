...
import { IconHome, IconUser, IconBuilding, IconClipboardList, IconCalendar, IconUsers, IconMapPin, IconShoppingCart } from "@tabler/icons-react";

export interface NavItem {
  href: string;
  label: string;
  icon: typeof IconHome | typeof IconUser | typeof IconBuilding | typeof IconClipboardList | typeof IconCalendar | typeof IconUsers | typeof IconMapPin | typeof IconShoppingCart;
