...
import { IconHome, IconUser, IconBuilding, IconBuildingStore, IconStore, IconClipboardList, IconCalendar, IconUsers, IconMapPin, IconShoppingCart } from "@tabler/icons-react";

export interface NavItem {
  href: string;
  label: string;
  icon: typeof IconHome | typeof IconUser | typeof IconBuilding | typeof IconBuildingStore | typeof IconStore | typeof IconClipboardList | typeof IconCalendar | typeof IconUsers | typeof IconMapPin | typeof IconShoppingCart;
...
export const APP_NAV: NavItem[] = [
  ...
  { href: ROUTES.OUTLETS, label: "Outlets", icon: IconStore },
